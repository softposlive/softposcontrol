 ...
 * @author softpos
 */
public class Report_Dailysale extends javax.swing.JDialog {

    /**
     * Creates new form Report_Dailysale
     */
    public Report_Dailysale(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "วันที่ขาย (Date)", "MacNo", "เลขที่ใบกำกับภาษี", "โต๊ะ", "จำนวนลูกค้า", "เวลาเข้า", "เวลาออก", "อาหาร Food ", "เครื่องดื่ม", "สินค้า", "ส่วนลด (Disc)", "ค่าบริการ", "จำนวนเงินสุทธิ", "ภาษีมูลค่าเพิ่ม", "เงินสด (Cash)", "บัตรกำนัล", "เครดิต", "ลูกหนี้ AR"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, false, true, false, true, false, false, false, false, false, false, false
            };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Dailysale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Dailysale dialog = new Report_Dailysale(new javax.swing.JFrame(), true);
