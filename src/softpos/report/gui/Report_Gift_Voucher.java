 ...
 * @author softpos
 */
public class Report_Gift_Voucher extends javax.swing.JDialog {

    /**
     * Creates new form Report_Gift_Voucher
     */
    public Report_Gift_Voucher(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder("กำหนดช่วงวันที่"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "วันที่ (Date)", "รหัสบัตรกำนัน", "จำนวนเงิน", "เลขที่ใบเสร็จ", "MacNO"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Gift_Voucher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Gift_Voucher dialog = new Report_Gift_Voucher(new javax.swing.JFrame(), true);
