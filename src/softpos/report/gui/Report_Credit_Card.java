 ...
 * @author softpos
 */
public class Report_Credit_Card extends javax.swing.JDialog {

    /**
     * Creates new form Report_Credit_Card
     */
    public Report_Credit_Card(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายงานการรับบัตรเครดิต");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "วันที่ (Date)", "รหัสประเภทบัตร", "ชื่อบัตรเครดิต", "รหัสบัตรเครดิต", "รหัสอนุมัติ", "ผู้บันทึก", "จำนวนเงิน", "เลขที่ใบเสร็จ", "MacNO"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Credit_Card.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Credit_Card dialog = new Report_Credit_Card(new javax.swing.JFrame(), true);
