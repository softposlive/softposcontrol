 ...
 * @author softpos
 */
public class Report_Void extends javax.swing.JDialog {

    /**
     * Creates new form Report_Void
     */
    public Report_Void(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายงานการ Void / รับคืนสินค้า");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ผู้ทำการ Void", "เวลาทำการ Void", "รหัสสินค้า (PLU)", "ชื่อสินค้า", "จำนวน", "จำนวนเงิน", "สาเหตุการ Void", "วันที่ขาย", "เวลาที่ขาย", "MacNo", "Cashier", "โต๊ะ"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Void.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Void dialog = new Report_Void(new javax.swing.JFrame(), true);
