 ...
 * @author softpos
 */
public class Report_Cashier_PLU extends javax.swing.JDialog {

    /**
     * Creates new form Report_Cashier_PLU
     */
    public Report_Cashier_PLU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายงานการขายตามรหัสพนักงาน");
        ...
        jPanel12.setBorder(javax.swing.BorderFactory.createTitledBorder("รหัสพนักงาน"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "กลุ่มสินค้า", "รายการอาหาร", "รายละเอียด (ชื่อสินค้า)", "จำนวน", "ราคา/หน่วย", "จำนวนเงิน", "ส่วนลด", "จำนวนเงินสุทธิ"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Cashier_PLU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Cashier_PLU dialog = new Report_Cashier_PLU(new javax.swing.JFrame(), true);
