 ...
 * @author softpos
 */
public class Report_Receipt extends javax.swing.JDialog {

    /**
     * Creates new form Report_Vat_POS
     */
    public Report_Receipt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายงานการพิมพิ์ใบกำกับภาษีอย่างย่อ (จากเครื่อง POS)");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MacNO", "รหัสอนุมัติฯ", "มูลค่าสินค้า/บริการ", "ภาษีมูลค่าเพิ่ม (Vat)", "เลขที่ใบกำกับภาษี", "ผู้บันทึก", "จำนวนเงินรวม", "รายการ (Description)", "วันที่ขาย"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Receipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Receipt dialog = new Report_Receipt(new javax.swing.JFrame(), true);
