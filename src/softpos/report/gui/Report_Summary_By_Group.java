 ...
 * @author softpos
 */
public class Report_Summary_By_Group extends javax.swing.JDialog {

    /**
     * Creates new form Report_Summary_By_Group
     */
    public Report_Summary_By_Group(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("สรุปการขายตามผู้ขาย (Summary By Group)");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "กลุ่ม", "ชื่อกลุ่ม (Description)", "จำนวนเงิน (ขาย)", "เปอร์เซ็นจากการขายรวม"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_Summary_By_Group.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_Summary_By_Group dialog = new Report_Summary_By_Group(new javax.swing.JFrame(), true);
